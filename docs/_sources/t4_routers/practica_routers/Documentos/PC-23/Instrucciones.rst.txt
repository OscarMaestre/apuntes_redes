...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.23.0.0/16 via 3.23.0.2

En Abajo podemos ejecutar esto::

	sudo ip route add 1.23.0.0/16 via 3.23.0.1
...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.23.0.0/16 via 2.23.0.2

En Arriba podemos ejecutar esto::

	sudo ip route add 1.23.0.0/16 via 2.23.0.1
	sudo ip route add 6.23.0.0/16 via 5.23.0.2

En Abajo podemos ejecutar esto::

	sudo ip route add 1.23.0.0/16 via 5.23.0.1
