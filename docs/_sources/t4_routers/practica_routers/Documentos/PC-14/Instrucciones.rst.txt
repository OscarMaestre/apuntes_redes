...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.14.0.0/16 via 3.14.0.2

En Abajo podemos ejecutar esto::

	sudo ip route add 1.14.0.0/16 via 3.14.0.1
...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.14.0.0/16 via 2.14.0.2

En Arriba podemos ejecutar esto::

	sudo ip route add 1.14.0.0/16 via 2.14.0.1
	sudo ip route add 6.14.0.0/16 via 5.14.0.2

En Abajo podemos ejecutar esto::

	sudo ip route add 1.14.0.0/16 via 5.14.0.1
