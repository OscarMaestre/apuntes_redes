...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.18.0.0/16 via 3.18.0.2

En Abajo podemos ejecutar esto::

	sudo ip route add 1.18.0.0/16 via 3.18.0.1
...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.18.0.0/16 via 2.18.0.2

En Arriba podemos ejecutar esto::

	sudo ip route add 1.18.0.0/16 via 2.18.0.1
	sudo ip route add 6.18.0.0/16 via 5.18.0.2

En Abajo podemos ejecutar esto::

	sudo ip route add 1.18.0.0/16 via 5.18.0.1
