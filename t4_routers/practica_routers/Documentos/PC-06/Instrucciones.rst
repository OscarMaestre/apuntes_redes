...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.6.0.0/16 via 3.6.0.2/16

En Abajo podemos ejecutar esto::

	sudo ip route add 1.6.0.0/16 via 3.6.0.1/16
...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.6.0.0/16 via 2.6.0.2/16

En Arriba podemos ejecutar esto::

	sudo ip route add 1.6.0.0/16 via 2.6.0.1/16
	sudo ip route add 6.6.0.0/16 via 5.6.0.2/16

En Abajo podemos ejecutar esto::

	sudo ip route add 1.6.0.0/16 via 5.6.0.1/16
