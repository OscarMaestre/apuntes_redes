...
* Cliente 1: la tarjeta enp0s3 tiene la IP **1.112.101.10/16**
* Cliente 2: la tarjeta enp0s3 tiene la IP **6.112.101.10/16**
...
Router izquierda::
	...
	network 1.112.0.0/16 area 1
	network 2.112.0.0/16 area 1
	network 3.112.0.0/16 area 1

Router Arriba::

	network 2.112.0.0/16 area 1
	network 5.112.0.0/16 area 1

Router Abajo::

	network 6.112.0.0/16 area 1
	network 3.112.0.0/16 area 1
	network 5.112.0.0/16 area 1
