...
* Cliente 1: la tarjeta enp0s3 tiene la IP **1.13.101.10/16**
* Cliente 2: la tarjeta enp0s3 tiene la IP **6.13.101.10/16**
...
Ejercicio 3
--------------
En el router de arriba hemos dejado una tarjeta sin usar. Ponle la dirección 10.9.0.213/24 y reconfigura las rutas para que Cliente 1 pueda hacer ping al router del instituto (10.9.0.254).
