...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.21.0.0/16 via 3.21.0.2

En Abajo podemos ejecutar esto::

	sudo ip route add 1.21.0.0/16 via 3.21.0.1
...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.21.0.0/16 via 2.21.0.2

En Arriba podemos ejecutar esto::

	sudo ip route add 1.21.0.0/16 via 2.21.0.1
	sudo ip route add 6.21.0.0/16 via 5.21.0.2

En Abajo podemos ejecutar esto::

	sudo ip route add 1.21.0.0/16 via 5.21.0.1
