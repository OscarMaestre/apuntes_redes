...
* Cliente 1: la tarjeta enp0s3 tiene la IP **1.108.101.10/16**
* Cliente 2: la tarjeta enp0s3 tiene la IP **6.108.101.10/16**
...
Router izquierda::
	...
	network 1.108.0.0/16 area 1
	network 2.108.0.0/16 area 1
	network 3.108.0.0/16 area 1

Router Arriba::

	network 2.108.0.0/16 area 1
	network 5.108.0.0/16 area 1

Router Abajo::

	network 6.108.0.0/16 area 1
	network 3.108.0.0/16 area 1
	network 5.108.0.0/16 area 1
