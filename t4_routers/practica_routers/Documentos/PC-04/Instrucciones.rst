...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.4.0.0/16 via 3.4.0.2/16

En Abajo podemos ejecutar esto::

	sudo ip route add 1.4.0.0/16 via 3.4.0.1/16
...
En Izquierda podemos ejecutar esto::
	...
	sudo ip route add 6.4.0.0/16 via 2.4.0.2/16

En Arriba podemos ejecutar esto::

	sudo ip route add 1.4.0.0/16 via 2.4.0.1/16
	sudo ip route add 6.4.0.0/16 via 5.4.0.2/16

En Abajo podemos ejecutar esto::

	sudo ip route add 1.4.0.0/16 via 5.4.0.1/16
